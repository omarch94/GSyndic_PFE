...
@section('title', 'Ajouter une copropriété')

@section('content_header')
    <div class="header my-4 d-flex justify-content-between">
        <h4 class="">Ajouter une nouvelle copropriété</h4>
...
@section('content')
    ...
    <div class="section_form">
        <div class="p-5 bg-white">
            <form action="/coproprietes" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="">
                    ...
                    <div class="row mb-4">
                        <div class="form-group col-6">
                            ...
                            <input name="code_postal" id="code_postal" type="text" class="form-control @error('code_postal') is-invalid @enderror" value="{{ old('code_postal') }}">
                            @error('code_postal')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="form-group col-6">
                            ...
                            <input name="interface" id="interface" type="text" class="form-control @error('interface') is-invalid @enderror" value="{{ old('interface') }}">
                            @error('interface')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input name="nb_lots" id="nb_lots" type="number" class="form-control @error('nb_lots') is-invalid @enderror" value="{{ old('nb_lots') }}">
                            @error('nb_lots')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="form-group col-6">
                            ...
                            <input name="date_creation" id="date_creation" type="date" class="form-control @error('date_creation') is-invalid @enderror" value="{{ old('date_creation') }}">
                            @error('date_creation')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input name="date_modification" id="date_modification" type="date" class="form-control @error('date_modification') is-invalid @enderror" value="{{ old('date_modification') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="coproprietaire_id" id="coproprietaire_id" class="form-control @error('coproprietaire_id') is-invalid @enderror">
                            ...
                            @foreach($coproprietaires as $coproprietaire)
                                <option value="{{$coproprietaire->id}}" @selected(old('coproprietaire_id') == $coproprietaire->id)>{{$coproprietaire->nom}} {{$coproprietaire->prenom}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-4">
                        <label class="mb-2" for="role_id">Description : </label>
