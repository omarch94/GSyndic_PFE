...
@section('content_header')
    <div class="header my-4 d-flex justify-content-between">
        <h4 class="">Ajouter un nouvau immeuble</h4>
...
@section('content')
    ...
    <div class="section_form">
        <div class="p-5 bg-white">
            <form action="/immeubles" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="">
                    ...
                    <div class="row mb-4">
                        <div class="form-group col-4">
                            ...
                            <input name="nb_etages" id="nb_etages" type="number" class="form-control @error('nb_etages') is-invalid @enderror" value="{{ old('nb_etages') }}">
                            @error('nb_etages')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-4">
                            ...
                            <input name="nb_logements" id="nb_logements" type="number" class="form-control @error('nb_logements') is-invalid @enderror" value="{{ old('nb_logements') }}">
                            @error('nb_logements')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-4">
                            ...
                            <input name="annee_construction" id="annee_construction" type="number" class="form-control @error('annee_construction') is-invalid @enderror" value="{{ old('annee_construction') }}">
